        ...
        <table class="table table-hover table-condensed">
            <? foreach( $tree->getChild() as $node ):?>
                <tr>
                    ...
                    <td><?= $node->title ?></td>
                    <td class="text-right"><a href="/admin/section/edit/?id=<?= $node->id ?>" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-pencil"></span></a> <a class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span></a></td>
                </tr>
